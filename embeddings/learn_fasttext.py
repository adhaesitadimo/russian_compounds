...
if __name__ == '__main__':
	...
	model = FastText(size=700, window=5, min_count=2, workers=multiprocessing.cpu_count())
	print('Building vocabulary')
	model.build_vocab(sentences=myIter())
	print('Started training')
	model.train(sentences=myIter(), total_examples=model.corpus_count, epochs=15)
	print('Saving model')
	model.save('ruwiki.fasttext.model')